...
//   inputElChange = event => {
//     this.setState({filterdAppInput: event.target.value})
//   }

//   getFilterdApps = inputSearchResult => {
//     const {slectedTab} = this.state
//     const filterdApps = inputSearchResult.filter(
//       eachFilterdApp => eachFilterdApp.category === slectedTab,
//     )
//     return filterdApps
//   }

//   getInputSearchResult = () => {
//     const {filterdAppInput} = this.state
//     const inputSearchResult = appsList.filter(eachInputApp =>
//       eachInputApp.appName
//         .toLowerCase()
//         .includes(filterdAppInput.toLowerCase()),
//     )
...
//   render() {
//     const {slectedTab} = this.state
//     const inputSearchResult = this.getInputSearchResult()
//     const filterdApps = this.getFilterdApps(inputSearchResult)

//     return (
//       <div className="main-div">
//         <div className="main-container">
//           <h1>App Store</h1>
//           <input onChange={this.inputElChange} type="search" />
//           <img
//             alt="search icon"
...
//                 <TabItem
//                   tabKey={eachItem.tabId}
//                   getSelectedTab={this.getSelectedTab}
//                   eachTab={eachItem}
//                   isApplied={eachItem.tabId === slectedTab}
//                 />
//               ))}
//             </ul>
//           </div>
...
//               {filterdApps.map(eachApp => (
//                 <AppItem appKey={eachApp.appId} eachAppList={eachApp} />
//               ))}
//             </ul>
//           </div>
//         </div>
